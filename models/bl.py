...
cfg = {
    'Baysian_Ma': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M'],
...
def vgg19(use_batch_norm: bool = True, layers: str = 'Baysian_Ma', state_dict: str = None):
    ...
    if state_dict is None:
        if not use_batch_norm:
            state_dict=torch.load("/HOME/scz3349/.cache/torch/hub/checkpoints/vgg19-dcbb9e9d.pth")
            model.load_state_dict(state_dict, strict=False)
        else:
            state_dict = torch.load("/HOME/scz3349/.cache/torch/hub/checkpoints/vgg19_bn-c79401a0.pth")
            model.load_state_dict(state_dict, strict=False)
    else:
